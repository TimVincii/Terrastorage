...
public class LocalizedTextProvider {
    ...
    public static void sendUnsupportedMessage() {
        Minecraft.getInstance().player.sendSystemMessage(Component.translatable("terrastorage.message.unsupported_packet"));
    }

    public static void sendCooldownMessage() {
        Minecraft.getInstance().player.sendSystemMessage(Component.translatable("terrastorage.message.packet_cooldown"));
    }
}
