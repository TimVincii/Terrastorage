...
public class TerrastorageKeybindings {
    private static final KeyMapping.Category terrastorage_main = KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "keybinding_main"));
