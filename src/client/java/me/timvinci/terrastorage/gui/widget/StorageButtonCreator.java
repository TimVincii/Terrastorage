...
public class StorageButtonCreator {
    ...
    private static WidgetSprites getButtonTextures(String buttonName) {
        ...
        return new WidgetSprites(
                ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, stylePrefix + "_" + buttonName),
                ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, stylePrefix + "_" + buttonName + "_highlighted")
        );
    }
}
