...
public class ButtonsCustomizationScreen extends Screen {
    private static final ResourceLocation TEXTURE = ContainerScreenAccessor.CONTAINER_BACKGROUND();
    ...
    protected void init() {
        ...
        this.addRenderableWidget(actionWidgets.get(actionWidgets.size()-1));
    }
    ...
    /**
     * Adds the rendering of the background and title.
     */
    @Override
    ...
    public void renderBackground(GuiGraphics context) {
        ...
        context.blit(TEXTURE, i, j, 0, 0, backgroundWidth, rows * 18 + 17);
        context.blit(TEXTURE, i, j + rows * 18 + 17, 0, 126, backgroundWidth, 96);
